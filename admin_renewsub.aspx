<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Master.master" AutoEventWireup="true" CodeFile="admin_renewsub.aspx.cs" Inherits="admin_renewsub" %>
...
<asp:Label ID="Label3" runat="server" Text="Renew Paid Subscriber's Account" ForeColor="#FF6600"></asp:Label><br /><br />
For accepting / rejecting Paid Subscriber's Renew Account request click on the name of the applicant<br /><br />
<center>
<table cellspacing="0px" border="0" cellpadding="5px">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT p.psubid, p.ptitle, p.pfirstname, p.psurname, p.pcountry, CONVERT(VARCHAR(10), d.psubmitdate, 105) DATE1, d.pddnumber, d.pddbank, CONVERT(VARCHAR(10), d.pddmakedate, 105) DATE2, s.schduration, s.schamount FROM PAID_SUBSCRIBER_MASTER p, PAID_SUBSCRIBER_DRAFT_MASTER d, SCHEME_MASTER s WHERE d.pschemeid = s.schemeid AND d.pddstatus = 'pending' AND p.pactivedate IS NOT NULL AND p.psubid = d.psubid AND pacctype = 'True'">
    </asp:SqlDataSource>
    <asp:HiddenField ID="HiddenField1" runat="server" /></center>
...
<asp:Label ID="Label1" runat="server" Text="Label"></asp:Label><br /><br />
    <asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click">Renew Subscription</asp:LinkButton>
    &nbsp;
    <asp:LinkButton ID="LinkButton2" runat="server" onclick="LinkButton2_Click">Cancel Subscription</asp:LinkButton>
    &nbsp;
