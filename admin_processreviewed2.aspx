<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Master.master" AutoEventWireup="true" CodeFile="admin_processreviewed2.aspx.cs" Inherits="admin_processreviewed2" %>
...
<asp:Label ID="Label9" runat="server" Text="Process Re - Reviewed Journal" ForeColor="#FF6600"></asp:Label><br /><br />
...
<table cellpadding="5px" cellspacing="0px" border="0">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT DISTINCT r.paperid, p.papertitle, p.subjarea, a.afirstname, COUNT(r.paperid) AS Expr1, DATEDIFF(day, r.datereview, { fn CURDATE() }) AS DATE1 FROM PAPER_REVIEWING_DETAIL AS r INNER JOIN PAPER_MASTER AS p ON r.paperid = p.paperid INNER JOIN AUTHOR_MASTER AS a ON p.authid = a.authid WHERE (NOT (r.papreviewstatus = 'evaluated')) AND (p.paperstatus = 'rereviewing') GROUP BY r.paperid, p.papertitle, p.subjarea, a.afirstname, r.datereview">
    </asp:SqlDataSource>
