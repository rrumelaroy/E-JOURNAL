<%@ Page Title="" Language="C#" MasterPageFile="~/paid_subs_master.master" AutoEventWireup="true" CodeFile="paidsub_setpass.aspx.cs" Inherits="paidsub_setpass" %>
...
<div style="margin:10px 10px 10px 10px; border-color:Silver; border-style:solid; border-width:medium;">
    ...
    <tr><td colspan="2">
    Reset your password by providing your existing detail in the following
    </td></tr>
    <tr valign="top">
