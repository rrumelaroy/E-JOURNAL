...
public partial class setpassword : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //if (type == "author")
          //  this.MasterPageFile = "author_master.master";
    }
        ...
        else if (type == "paidsubscriber")
        {
            if (paidsub_chkpass(pk, TextBox1.Text) == true)
            {
                ...
                if (checklength(TextBox2.Text, 6) == true)
                {
                    ...
                    {
                        Label13.Visible = false;
                        paidsub_setpass(pk, TextBox2.Text);
                        Label14.Visible = true;
                    }
                    else
                        Label13.Visible = true;
    ...
    void paidsub_setpass(string pk, string pass)
    {
        con.Close();
        con.Open();
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        else if (type == "freesubscriber")
            Response.Redirect("fsub_profile.aspx");
        else if (type == "paidsubscriber")
            Response.Redirect("psub_profile.aspx");
    }
}