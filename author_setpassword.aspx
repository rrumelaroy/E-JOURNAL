<%@ Page Title="" Language="C#" MasterPageFile="~/author_master.master" AutoEventWireup="true" CodeFile="author_setpassword.aspx.cs" Inherits="author_setpass" %>
...
<asp:HyperLink ID="HyperLink1" runat="server" ForeColor="Blue" NavigateUrl="~/author_profile.aspx">Profile</asp:HyperLink> &nbsp; |&nbsp; 
...
<div style="margin:10px 10px 10px 10px; border-color:Silver; border-style:solid; border-width:medium;">
    ...
    <tr valign="top">
    <td style="color:Gray;">Current Password* :</td>
    <td>
    ...
    <tr valign="top">
    <td style="color:Gray;">New Password* :</td>
    <td>
